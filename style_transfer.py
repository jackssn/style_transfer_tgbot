...
def run_style_transfer(cnn, normalization_mean, normalization_std,
    ...
    while 1:
        ...
        print(run[0], num_steps, run[0] <= num_steps)
...
def main(imsize=128, num_steps=200, img_style="images/picasso.jpg", img_content="images/lisa.jpg"):
    ...
    w, h, r = img_content_size[0], img_content_size[1], img_content_size[0] / img_content_size[1]
    ...
    loader = transforms.Compose([
        transforms.Resize(size=(h_new, w_new)),  # нормируем размер изображения
    ...
    output = run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                                content_img, style_img, input_img, device, num_steps=num_steps)
